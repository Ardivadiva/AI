...
# Configuration for displaying keras device logs
sess = tf.compat.v1.Session(config=tf.compat.v1.ConfigProto(log_device_placement=True))

# Create a directory to save model output
path = "output_dir/"
try:
    os.makedirs(path)
except:
...
# Read dataset from clean_qa.txt file
...
# Function to save tokenizer to a pickle file
...
# Configuration for logs and checkpointing
